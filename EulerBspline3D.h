...
public:
    ...
    EulerBspline3D(ON_3dVector vs, ON_3dVector ve, double length);                // 起点是原点，终点是(length,0,0)，起始切向vs，终点切向是ve
    EulerBspline3D(ON_3dPoint ps, ON_3dPoint pe, ON_3dVector vs, ON_3dVector ve); // 起点是ps，终点是pe，起始切向vs，终点切向是ve
